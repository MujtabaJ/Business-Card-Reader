...
public class SaveTxt extends AppCompatActivity {
            ...
            case REQUEST_CAMERA_PERMISSION_ID:
                if (grantResults[0] == PackageManager.PERMISSION_GRANTED){
                    if (ActivityCompat.checkSelfPermission(this, Manifest.permission.CAMERA)
                        ...
                        ActivityCompat.requestPermissions(SaveTxt.this,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        handler.postDelayed(new Runnable(){
            @Override
            public void run() {
                Intent intent = new Intent(SaveTxt.this, ProfileCreatorActivity.class);
    ...
    public void onBackPressed(){
        Intent intent = new Intent(SaveTxt.this, MainActivity.class);
        startActivity(intent);
        finish();
    }
}
